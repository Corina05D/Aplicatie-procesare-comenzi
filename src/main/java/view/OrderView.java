...
public class OrderView extends JFrame {
    ...
    public OrderView() {
        ...
        JLabel titleLabel = new JLabel("Operatii Comenzi");
        titleLabel.setHorizontalAlignment(SwingConstants.CENTER);
        titleLabel.setFont(new Font("Times New Roman", Font.BOLD, 18));
        titleLabel.setBounds(60, 20, 200, 25);
        contentPane.add(titleLabel);

        JLabel addLabel = new JLabel("Adauga comanda");
        ...
        JLabel deleteLabel = new JLabel("Sterge comanda cu id:");
        deleteLabel.setHorizontalAlignment(SwingConstants.CENTER);
        deleteLabel.setBounds(90, 195, 140, 15);
        contentPane.add(deleteLabel);

        deleteFld = new JTextField();
        deleteFld.setColumns(10);
        deleteFld.setBounds(232, 194, 35, 20);
        ...
        JLabel viewLabel = new JLabel("Vizualizare comenzi");
